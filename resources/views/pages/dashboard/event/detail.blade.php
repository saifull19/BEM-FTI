                        ...
                        <div class="col-span-4 lg:text-right">
                            <div class="relative mt-0 md:mt-6">
                                ...
                                <button class="">
                                 ...
                                 <form action="{{ route('member.event.destroy', $webinar->id) }}" method="post" >
                                  @method('delete')
                                  @csrf
                ...
                <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
                    <ol class="inline-flex p-0 list-none">
                        ...
                        <li class="flex items-center">
                            ...
                            <a href="{{ route('member.event.index') }}" class="text-gray-400">My Webinar</a>
                                ...
                                <section class="pt-6 pb-20 mx-8 w-auth">
                                    <div class="grid gap-5 md:grid-cols-12">
                                        ...
                                        <div class="p-4 md:text-right lg:col-span-6 md:col-span-12">
                                            ...
                                            <a href="{{ route('member.event.edit', $webinar->id) }}" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white border border-transparent rounded-lg shadow-sm bg-serv-email hover:bg-serv-email-text focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-serv-email">
                                                Edit Webinar
                                            </a>
                                        </div>
