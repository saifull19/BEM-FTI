    ...
    <main class="h-full overflow-y-auto">
                    ...
                    <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                        <div class="col-span-8">
                            ...
                            <p class="text-sm text-gray-400">
                                {{ auth()->user()->service()->count() }} All Gallery
                            </p>
                ...
                <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
                    <ol class="inline-flex p-0 list-none">
                        ...
                        <li class="flex items-center">
                            <a href="#" class="font-medium">Details Kegiatan</a>
                        </li>
                                            ...
                                            <div class="content">
                                                <div>
                                                    ...
                                                    <div class="leading-8 text-md">
                                                        ...
                                                        <h2 class="text-xl font-semibold">Description This <span class="text-serv-button">Gallery</span></h2>
                                                        ...
                                                        <h3 class="my-4 pb-4 text-lg font-semibold">Why choose my Gallery?</h3>
                                            ...
                                            <div class="mb-4 border rounded-lg border-serv-testimonial-border">
                                                <div class="flex items-center px-2 py-3 mx-4 mt-4 border rounded-full border-serv-testimonial-border">
                                                    ...
                                                    <div class="flex-1 text-sm font-medium text-center">
                                                        ...
                                                        Waktu Pelaksanaan {{ $service->delivery_time ?? '' }} 
                                                    </div>
                                                    ...
                                                    <div class="flex-1 text-sm font-medium text-center">
                                                        ...
                                                        Tempat Pelaksanaan {{ $service->revision_limit ?? '' }} 
                                                    </div>
